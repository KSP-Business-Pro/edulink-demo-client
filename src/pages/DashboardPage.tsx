...
export function DashboardPage() {
  ...
  // ── État skeleton (premier chargement) ───────────────────────────────────
  ...
  // ── Rendu normal (avec rafraîchissement possible en arrière-plan) ─────────
  return (
    <div style={styles.page}>
      <style>{keyframes}</style>
...
// ── Styles ─────────────────────────────────────────────────────────────────
const styles = {
  page:        { padding: '1.5rem 2rem', maxWidth: 1100, margin: '0 auto', fontFamily: "'Segoe UI', sans-serif", background: '#FBFAF6', background: '#FBFAF6' } as React.CSSProperties,
  ...
  retryBtn:    { padding: '9px 20px', background: '#1e3a5f', color: '#fff', border: 'none', borderRadius: 8, fontSize: 13, fontWeight: 600, cursor: 'pointer' } as React.CSSProperties,
};
