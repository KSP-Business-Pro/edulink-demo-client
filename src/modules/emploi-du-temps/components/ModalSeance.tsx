      ...
      <div style={S.modal}>
        ...
        <div style={S.body}>
          ...
          <div style={S.row2}>
            ...
            <div style={S.field}>
              <label style={S.label}>Type de séance <span style={S.req}>*</span></label>
              <select style={S.input} value={form.type_seance}
          ...
          <div style={S.row2}>
            <div style={S.field}>
              <label style={S.label}>Heure début <span style={S.req}>*</span></label>
              <select style={S.input} value={form.heure_debut}
                onChange={e => set('heure_debut', e.target.value)}>
                {HEURES.map(h => <option key={h} value={h}>{h}</option>)}
              </select>
            </div>
            <div style={S.field}>
              <label style={S.label}>Heure fin <span style={S.req}>*</span></label>
              <select style={S.input} value={form.heure_fin}
          ...
          <div style={S.field}>
            ...
            <select style={S.input} value={form.semestre_id}
          ...
          {/* Matière */}
          <div style={S.field}>
            <label style={S.label}>Matière <span style={S.req}>*</span></label>
            <select
          ...
          {/* Enseignant */}
          <div style={S.field}>
            <label style={S.label}>Enseignant</label>
            <select style={S.input} value={form.enseignant_id ?? ''}
