      ...
      <div className="modal" style={{ width: 480, padding: '1.5rem' }}>
        ...
        <form onSubmit={handleSubmit} autoComplete="off">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '.5rem', marginBottom: '1.2rem' }}>
            <input type="checkbox" id="annee-courante" checked={estCourante}
          ...
          {estCourante && (
            <div style={{ background: '#fef3c7', border: '1px solid #fde68a', borderRadius: 8, padding: '8px 12px', fontSize: 12, color: '#92400e', marginBottom: '1rem' }}>
              ⚠️ Les autres années seront marquées comme non courantes.
            </div>
          )}
          {error && (
            <div style={{ background: '#fee2e2', color: '#dc2626', padding: '8px 12px', borderRadius: 8, fontSize: 12, marginBottom: '1rem' }}>{error}</div>
          )}
