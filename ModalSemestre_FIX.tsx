      ...
      <div className="modal" style={{ width: 560, padding: '1.5rem' }}>
        ...
        <form onSubmit={handleSubmit} autoComplete="off">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '.75rem', marginBottom: '.85rem' }}>
            <div>
              <label htmlFor="sem-programme">Programme *</label>
              <select
                id="sem-programme" name="programme_id"
                value={progId}
            ...
            <div>
              <label htmlFor="sem-annee">Année académique</label>
              <select
                id="sem-annee" name="annee_academique_id"
                value={anneeId}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '.75rem', marginBottom: '.85rem' }}>
            <div>
              <label htmlFor="sem-numero">N° semestre *</label>
              <input
                id="sem-numero" name="numero"
                type="number"
                value={numero}
            ...
            <div>
              <label htmlFor="sem-libelle">Libellé *</label>
              <input
                id="sem-libelle" name="libelle"
                type="text"
                value={libelle}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '.75rem', marginBottom: '.85rem' }}>
            <div>
              <label htmlFor="sem-niveau">Niveau *</label>
              <select
                id="sem-niveau" name="niveau"
                value={niveau}
            ...
            <div>
              <label htmlFor="sem-statut">Statut *</label>
              <select
                id="sem-statut" name="statut"
                value={statut}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '.75rem', marginBottom: '1.2rem' }}>
            <div>
              <label htmlFor="sem-date-debut">Date début</label>
              <input
                id="sem-date-debut" name="date_debut"
                type="date"
                value={dateDebut}
            ...
            <div>
              <label htmlFor="sem-date-fin">Date fin</label>
              <input
                id="sem-date-fin" name="date_fin"
                type="date"
                value={dateFin}
