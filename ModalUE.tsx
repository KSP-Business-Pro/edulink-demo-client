      ...
      <div className="modal" style={{ width: 520, padding: '1.5rem' }}>
        ...
        <form onSubmit={handleSubmit} autoComplete="off">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '.75rem', marginBottom: '.85rem' }}>
            <div>
              <label htmlFor="ue-code">Code *</label>
              <input
                id="ue-code" name="code"
                type="text"
                value={code}
            ...
            <div>
              <label htmlFor="ue-intitule">Intitulé *</label>
              <input
                id="ue-intitule" name="intitule"
                type="text"
                value={intitule}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '.75rem', marginBottom: '.85rem' }}>
            <div>
              <label htmlFor="ue-type">Type *</label>
              <select
                id="ue-type" name="type_ue"
                value={typeUE}
            ...
            <div>
              <label htmlFor="ue-credits">Crédits CECT *</label>
              <input
                id="ue-credits" name="credits"
                type="number"
                value={credits}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '.75rem', marginBottom: '.85rem' }}>
            <div>
              <label htmlFor="ue-poidscc">Pondération CC % *</label>
              <input
                id="ue-poidscc" name="poidsCc"
                type="number"
                value={poidsCc}
            ...
            <div>
              <label htmlFor="ue-poidsexam">Exam % (auto)</label>
              <input
                id="ue-poidsexam" name="poidsExam"
                type="number"
                value={poidsExam}
                readOnly
          ...
          {!isEdit && (
            <div style={{ marginBottom: '1.2rem' }}>
              <label htmlFor="ue-programme">Programme (optionnel)</label>
              <select
                id="ue-programme" name="programme"
                value={progId}
